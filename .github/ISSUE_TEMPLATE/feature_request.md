...
about: Something the product should do and does not
title: "[feature] "
labels: ["enhancement"]
assignees: []
---
...
<!-- The behavior you want, and the situation you are in when you want it. -->

## Why the current behavior is not enough

<!-- What you do instead today, and what that costs you. -->
