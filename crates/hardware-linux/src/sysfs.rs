...
use kori_core::telemetry::{Reading, Unavailable};
...
pub const SYSFS_ROOT_ENV: &str = "KORI_SYSFS_ROOT";
...
mod tests {
    ...
    fn temp_dir(name: &str) -> PathBuf {
        let dir = std::env::temp_dir().join(format!("kori-sysfs-{name}-{}", std::process::id()));
